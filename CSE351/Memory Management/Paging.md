...
A **page** is a fixed-size unit of data transfer between memory levels (RAM ↔ disk).
...
| Page offset | $p$ bits — indexes a byte within a page |
...
- Identifies pages in the virtual address space
- Range: 0 to $(N/P - 1)$

### Physical Page Number (PPN)
- Identifies pages in physical memory
- Range: 0 to $(M/P - 1)$
...
The page offset is identical in both — only the page number changes during translation.
