...
1. [[CSE444/Data Storage, Indexing, and Buffer Management/StorageComponents/Heap and Sorted Files|Heap and Sorted Files]] (Heap API, Searching, Sorted files)
2. [[CSE444/Data Storage, Indexing, and Buffer Management/StorageComponents/Index Types|Index Types: Clustered vs Secondary]] (Dense vs Sparse, Primary vs Secondary)
3. [[CSE444/Data Storage, Indexing, and Buffer Management/B+ Tree|B+ Trees]] (The most common index structure)
...
## Related
- [[CSE444/Data Storage, Indexing, and Buffer Management/B+ Tree|B+ Tree]] — full details on the B+ tree index structure
- [[CSE444/Data Storage, Indexing, and Buffer Management/Data Storage and Buffer Management|Data Storage and Buffer Management]] — page formats, record formats, heap file structure, and buffer pool management
