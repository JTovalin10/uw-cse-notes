...
1. **[[CSE444/Parallel/Data Partitioning Schemes|Data Partitioning]]**: Distributing rows across nodes.
2. **[[CSE444/Parallel/Parallel Query Execution|Parallel Query Processing]]**: Executing query operators concurrently.
...
The central design question is: **where does each row of data live?** The answer is determined by the [[CSE444/Parallel/Data Partitioning Schemes|Data Partitioning Schemes]].
