...
**`std::vector`** is a C++ standard library container that manages a dynamically resizable array on the heap. It is the most commonly used container in C++ and automatically handles memory allocation and deallocation via [[RAII|RAII]].
...
- **Internal Allocation**: Uses [[Systems Programming/C++ Fundamentals/Heap Management|`new`]] (or a custom allocator) to reserve a contiguous block of memory on the heap.
...
- [[Systems Programming/Memory Management/Heap Management|C Heap Management]]
