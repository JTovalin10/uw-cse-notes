...
1. **Threads**: Multiple threads of control within a single process, sharing the same address space.
    - **POSIX pthreads**: Low-level C API (`<pthread.h>`). See [[Systems Programming/Concurrency/Threads|Threads]].
    - **C++11 `std::thread`**: Modern, type-safe C++ API (`<thread>`). See [[C++ Concurrency|C++ Concurrency]].
2. **Processes**: Forking multiple processes with isolated address spaces. See [[Systems Programming/Process Management/Process Management|Process Management]].
...
- [[Systems Programming/Concurrency/Threads|Threads]]
- [[C++ Concurrency|C++ Concurrency]]
- [[Systems Programming/Process Management/Process Management|Process Management]]
- [[Networking Intro|Networking Intro]]
- [[POSIX IO|POSIX IO (Non-blocking I/O)]]
- [[Operating Systems/Concurrency/Synchronization/Mechanics/Synchronization|CSE451: Concurrency]]
