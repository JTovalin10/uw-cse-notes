...
**Smart pointers** are objects that store pointers to heap-allocated objects and manage their lifetime automatically using the **[[RAII|RAII]]** pattern. They look and behave like raw pointers (by overloading `*` and `->`), but additionally handle cleanup.
...
- See more: [[Unique Pointer|Unique Pointer]]
...
- See more: [[Shared Pointer|Shared Pointer]]
...
- See more: [[Weak Pointer|Weak Pointer]]
...
For the full mechanics of move constructors and move assignment, see [[Object Lifecycle|Object Lifecycle]].
