...
The C standard library (`<stdio.h>`) provides a high-level abstraction for file I/O called **streams**. Streams sit on top of [[POSIX IO|POSIX I/O]] and add buffering and formatted I/O.
...
- **`perror()`**: Prints a message and the error string associated with the global `errno`. See [[POSIX perror|POSIX perror]] for details.
...
- [[Systems Programming/File IO and POSIX/System Calls|System Calls]]
- [[POSIX IO|POSIX IO]]
- [[POSIX perror|POSIX perror]]
- [[Directory IO|Directory IO]]
