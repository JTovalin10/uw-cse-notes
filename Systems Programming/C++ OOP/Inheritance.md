...
- If a method is **not** `virtual`, the decision is made at **compile-time** (static dispatch) based on the pointer or reference type, regardless of the actual object type. See [[Static Dispatch|Static Dispatch]].
...
For a deep dive into timing and memory costs, see [[Virtual Table|Virtual Table]].
...
For more details and examples of Abstraction, see [[OOP Principles|OOP Principles]].
