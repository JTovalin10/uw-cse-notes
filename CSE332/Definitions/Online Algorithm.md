...
In the context of **Sorting**, an online sort can maintain a sorted list as new elements are added one at a time (e.g., [[CSE332/Sorting/Insertion Sort|Insertion Sort]] is an online algorithm).
