...
### Relational Algebra
- [[Introduction to Data Management/Query Execution/Relational Algebra|Relational Algebra]] — formal query language with set operations
...
- [[Introduction to Data Management/Query Execution/Parallel Query Execution|Parallel Query Execution]] — distributed query processing
...
- [[Introduction to Data Management/Transactions/Atomic and Isolated Transactions in SQL|Atomic and Isolated Transactions in SQL]] — ACID in SQL transactions
- [[Isolation Transactions in SQL|Isolation Transactions in SQL]] — isolation guarantees in SQL
- [[Introduction to Data Management/Transactions/Isolation Levels|Isolation Levels]] — serializable, repeatable read, read committed, etc.
