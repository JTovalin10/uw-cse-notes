...
- This is the gap between [[Introduction to Data Management/Transactions/Isolation Levels#Repeatable Read|Repeatable Read]] and [[Introduction to Data Management/Transactions/Isolation Levels#Serializable|Serializable]] isolation
...
## Related
- [[Introduction to Data Management/Transactions/Isolation Levels]] — how different isolation levels handle (or don't handle) phantom reads
