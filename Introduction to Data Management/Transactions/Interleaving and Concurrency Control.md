...
- [[Introduction to Data Management/Transactions/Atomic and Isolated Transactions in SQL]] — 2PL for achieving both atomicity and isolation
...
- [[Introduction to Data Management/Transactions/Isolation Levels]] — weaker isolation levels and their trade-offs

## Related
- [[Operating Systems/Concurrency/Synchronization/Mechanics/Locks/Locks|Locks (CSE451)]] — OS-level perspective on locking and synchronization
- [[Race Condition|Race Conditions]] — the OS-level analog of transaction conflicts
- [[Operating Systems/Concurrency/Synchronization/Mechanics/Synchronization|Synchronization]] — general concurrency control in OSes
