...
- [[Hashing + Ciphertext Integrity|CSE484 Hashing + Ciphertext Integrity]] — deeper treatment of hash functions, preimage/collision resistance, and HMAC
- [[Cryptography|CSE484 Cryptography]] — cryptographic primitives used in authentication systems
- [[Computer Security/Security Fundamentals/Other types of attacks|CSE484 Other types of attacks]] — SQL injection and other input-validation attacks
