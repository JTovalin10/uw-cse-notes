...
- [[Normalization|Normalization]] — what to do when an ER design has anomalies
- [[Create Table|Create Table]] — SQL syntax for creating the tables derived from ER diagrams
- [[Abstract Data Type|CSE331 Abstract Data Type]] — the analogous "class spec vs implementation" idea in software design
