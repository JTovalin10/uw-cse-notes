...
All operators take one or two relations as input and return a new relation. See [[Introduction to Data Management/Query Execution/Relational Algebra|Relational Algebra]] for an overview of RA.
...
## Related
- [[Introduction to Data Management/Query Execution/Relational Algebra|Relational Algebra]] — overview, query plan trees, and why joins are so common
