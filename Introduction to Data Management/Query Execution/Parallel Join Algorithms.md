...
**Parallel joins** operate in the [[Introduction to Data Management/Query Execution/Parallel Query Execution#The Shared-Nothing Model|shared-nothing model]]. The core idea: shuffle related values onto the same node, then perform a local join.

## Partitioned Hash Join

Same basic idea as [[Introduction to Data Management/Query Execution/Parallel Query Execution#Partitioned Aggregation|partitioned aggregation]]:
...
## Related
- [[Introduction to Data Management/Query Execution/Parallel Query Execution|Parallel Query Execution]] — architecture, partitioning strategies, and partitioned selection/aggregation
