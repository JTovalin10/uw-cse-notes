...
- [[Introduction to Data Management/Query Execution/Parallel Query Execution|Parallel Query Execution]] — pipelining interacts with the shared-nothing shuffle model
- [[Introduction to Data Management/Query Execution/Relational Algebra|Relational Algebra]] — the logical operators implemented by the pipeline
