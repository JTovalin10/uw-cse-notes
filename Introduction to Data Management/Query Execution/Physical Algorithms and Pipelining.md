...
## Related
- [[Introduction to Data Management/Query Execution/Relational Algebra|Relational Algebra]] — the logical operators being physically implemented
...
- [[Introduction to Data Management/Query Execution/Parallel Query Execution|Parallel Query Execution]] — how these single-node operators compose across machines
