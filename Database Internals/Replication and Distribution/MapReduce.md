...
- **GFS**: [[Google File System (GFS)|Google File System (GFS)]]
...
![[Parallel MapReduce Details.png]]
...
- [[Google File System (GFS)|Google File System (GFS)]] — the distributed file system that stores MapReduce input
- [[Intro to Parallel DBMS|Intro to Parallel DBMS]] — the parallel DBMS approach MapReduce is repeatedly contrasted against
- [[The Shuffle Operator|The Shuffle Operator]] — the same producer-consumer redistribution used between Map and Reduce
- [[Data Partitioning Schemes|Data Partitioning Schemes]] — partitioning and data skew in parallel systems
- [[Distributed Databases|Distributed Databases]] — shared-nothing distribution that MapReduce relies on
