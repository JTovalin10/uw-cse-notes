...
This avoids the full scan of $S$ for each tuple of $R$ that plain [[Nested Loop Join|nested loop join]] performs.
...
- [[Nested Loop Join|Nested Loop Join]] — the non-index variant
- [[Data Storage and Buffer Management|Data Storage and Buffer Management]] — index types (clustered vs. unclustered, B+ trees, hash indexes)
