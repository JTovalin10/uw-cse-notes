...
Hash join maps naturally onto the [[Query Execution & Algorithms#Iterator Interface|iterator interface]]:
...
- [[Partitioned Hash Algorithms|Partitioned Hash Join (Grace Join)]] — the two-pass hash join for relations larger than memory
- [[Nested Loop Join|Nested Loop Join]] — simpler alternative join algorithm
- [[Sort-Merge Join|Sort-Merge Join]] — sort-based join algorithm
- [[Query Execution & Algorithms|Query Execution]] — iterator interface used by all operators
