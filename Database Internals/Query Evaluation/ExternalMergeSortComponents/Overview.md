...
**External merge-sort** is a two-phase algorithm for sorting a relation that is too large to fit in memory. It is the foundation of [[Sort-Merge Join|sort-merge join]] for large relations.
