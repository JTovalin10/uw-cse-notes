...
1. [[Disk and Layout|Working with Disk & Storage Layout]] (Seek time, Row vs Column store)
2. [[Page and Record Formats|Page & Record Formats]] (Slotted pages, Fixed vs Variable records)
3. [[Heap File and LOBs|Heap Files & LOBs]] (Heap file implementations, BLOBs, CLOBs)
...
## Related
- [[Architecture|DBMS Architecture and Query Processing]] — how the buffer manager and storage manager fit into the full DBMS architecture
- [[Indexing|Indexes and File Organizations]] — heap file API, sorted files, and index structures built on top of heap files
