...
- **Subset-replicate**: Handle the heavy-hitter values separately from the rest.
  - For the "Justin Bieber values", separate them out and do a **[[Partitioned Hash Join#Broadcast Join (Optimizing for Small Relations)|broadcast join]]**.
...
![[Skew Join Algorithm.png]]

---

## Related

- [[Intro to Parallel DBMS|Intro to Parallel DBMS]] — the hardware architectures that necessitate these partitioning schemes
- [[Cost Estimation|Cost Estimation]] — how histograms are used to estimate cardinality and distribution
- [[Operator Algorithms|Operator Algorithms]] — how specific operators like joins benefit from partitioned data
