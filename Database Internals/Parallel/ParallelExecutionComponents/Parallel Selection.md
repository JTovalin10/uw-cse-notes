...
- **Cost Analysis**:
  - Assume a table $R$ is **[[Data Partitioning Schemes|block partitioned]]** across $N$ nodes.
...
- [[The Shuffle Operator|The Shuffle Operator]] — the mechanism used when an operator (unlike selection) does require data movement
