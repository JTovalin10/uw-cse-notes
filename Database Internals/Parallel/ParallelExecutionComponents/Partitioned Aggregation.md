...
![[Partitioned Aggregation.png]]

## Two Cases
Whether a [[The Shuffle Operator|shuffle]] is needed at all depends on how $R$ is already partitioned. Consider `SELECT A, sum(B) FROM R GROUP BY A`:
...
![[Partitioned Aggregation Union.png]]
...
![[With and Without Combiners.png]]
...
- [[The Shuffle Operator|The Shuffle Operator]] — the redistribution mechanism used by the naive and combiner approaches
- [[Operator Algorithms|Operator Algorithms]] — the single-node version of aggregation
