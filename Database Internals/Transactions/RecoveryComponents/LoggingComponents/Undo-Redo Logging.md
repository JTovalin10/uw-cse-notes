# Database Internals: Undo-Redo Logging

**Undo-Redo Logging** is the industry-standard logging strategy and the basis for modern recovery algorithms like [[Database Internals/Transactions/RecoveryComponents/ARIES|ARIES]]. It combines both strategies to support a **Steal / No-Force** buffer management policy, providing maximum flexibility and performance.
...
Undo-Redo logging follows the core **[[Database Internals/Transactions/RecoveryComponents/Write-Ahead Logging (WAL)|Write-Ahead Logging (WAL)]]** principle:
...
- **Winners** $\rightarrow$ Committed transactions
