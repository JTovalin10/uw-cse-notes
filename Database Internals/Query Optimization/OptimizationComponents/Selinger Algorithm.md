...
- [[Dynamic Programming|Dynamic Programming]] — the general DP framework this algorithm builds on
- [[Join Trees|Join Trees]] — left-deep, right-deep, and bushy tree shapes
- [[Cost Estimation|Cost Estimation]] — how plan costs are estimated
- [[Query Optimization|Query Optimization]] — overview
