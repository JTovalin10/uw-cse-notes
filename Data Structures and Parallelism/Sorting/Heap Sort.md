...
**Heap Sort**: A sorting algorithm that works by inserting all items into a max [[Binary Heap|Binary Heap]], then repeatedly extracting the largest element to fill a sorted list from right-to-left.
