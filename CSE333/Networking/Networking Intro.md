...
5. **Application Layer**: Defines the format and meaning of messages between application entities (e.g., [[CSE333/Networking/HTTP|HTTP]], [[CSE333/Networking/DNS|DNS]], SMTP, SSH).
...
- [[CSE333/Networking/DNS|DNS]]: Translates domain names (e.g., `google.com`) into IP addresses.
- [[CSE333/Networking/HTTP|HTTP]]: Web protocol for requesting and receiving resources.
