...
- **Smart Pointers**: `std::unique_ptr` and `std::shared_ptr` manage heap memory. See [[CSE333/Smart Pointers/Smart Pointers|Smart Pointers]].
- **Locks**: `std::lock_guard` and `std::unique_lock` manage mutexes. See [[CSE333/Concurrency/C++ Concurrency|C++ Concurrency]].
...
If you are writing an RAII class to manage a raw resource, you must follow the **[[CSE333/C++ OOP/Object Lifecycle#The Rule of Five|Rule of Five]]** to ensure that copying or moving the object does not lead to double-frees or dangling pointers.
...
- [[CSE333/Concurrency/C++ Concurrency|C++ Concurrency (Locks)]]
