...
For a full breakdown of each stage, see [[CSE333/Build Systems/GCC Workflow|GCC Workflow]].
...
- **gcc** — GNU Compiler Collection; the dominant open-source C/C++ compiler toolchain
- **Object file (`.o`)** — Relocatable machine code; equivalent to a "compilation unit" in other build systems
- **Segmentation Fault** — Memory access violation; known as an "access violation" on Windows
