...
Note that **independence** is not the same as **mutual exclusion**: independent events can both occur (their joint probability is the product of their marginals), whereas [[Foundations of Computing II/Part I - Discrete Mathematics/Basic Probability/Mutual Exclusion|mutually exclusive]] events can never both occur (their joint probability is 0).
