...
The probability that at least one of several events happens is never more than the sum of their individual probabilities. Summing the probabilities counts every overlap multiple times, so the sum overshoots the true union — making it a safe upper bound. The bound is exact only when the events are [[Foundations of Computing II/Part I - Discrete Mathematics/Basic Probability/Mutual Exclusion|mutually exclusive]]; it is the inequality counterpart of the exact [[Principle of Inclusion-Exclusion]].
