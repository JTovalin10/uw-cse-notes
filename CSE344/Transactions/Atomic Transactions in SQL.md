...
Locks guarantee **atomicity**, not **isolation** — for isolation, see [[CSE344/Transactions/Atomic and Isolated Transactions in SQL|2-Phase Locking (2PL)]].
...
- [[CSE344/Transactions/Atomic and Isolated Transactions in SQL]] — 2PL, which builds on locks to also guarantee isolation
