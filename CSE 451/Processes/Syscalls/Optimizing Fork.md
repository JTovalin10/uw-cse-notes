# Problem
1. the semantics of [[Fork]] say the child's address space is a copy of the parents
2. implementing fork() that way is too slow
	...
	3. have to copy parents address space contents into child's address space
