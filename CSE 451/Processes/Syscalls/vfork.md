...
- with a promise that the child wont modify the address space before doing an execve()
...
- READ ONLY PROTECTION
	- the OS marks those pages as ready-only in both the parent and childs page table - even if that part is usually writable (stack or heap)
- trigger
