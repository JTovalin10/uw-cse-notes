...
- thread state
	- the [[Program Counter]] - where in the code the thread is currently executing
	- the [[Stack Pointer]] - points to the top of the current execution stack
...
see also: [[Processes/Process|Process]]
