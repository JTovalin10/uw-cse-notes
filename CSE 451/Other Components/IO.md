...
- Buffering
	- the os stores data in a temporary memory area (buffer) while it is being transfered. this helps smooth out the speed difference between a fast CPU and a slow device