...
Dynamic analysis is covered in depth in the testing and delta debugging portions of CSE 403. See also [[Program Analysis Overview]] for how testing fits into the broader program analysis landscape.
...
- **Abstract interpretation**: A general framework for building sound static analyses by reasoning over abstract domains (see [[Program Analysis Overview#Abstract Interpretation (Primer)]]).
