...
Code review sits at the intersection of [[Version Control Fundamentals|version control]] and quality assurance. A pull request (PR) provides:
...
Code review complements [[Static Analysis]]: automated static analysis and linting catch mechanical defects (null dereferences, style violations, obvious type errors) before the PR even reaches a human reviewer. This frees reviewers to focus on what automation cannot catch — design problems, logic errors, domain-specific correctness, and knowledge transfer.
