...
- Open question from lecture: *What exactly is a unit? Is it possible and desirable to test units in isolation?* (This motivates mock-based testing — see [[Mock-Based Testing]].)
...
- UI testing with [[UI Testing and WebDriver]] is a form of system testing.
