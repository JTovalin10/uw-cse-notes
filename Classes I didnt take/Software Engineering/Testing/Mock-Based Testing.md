...
This technique directly addresses the open question raised in [[Testing and Continuous Integration]]: *is it possible and desirable to test units in isolation?* Mock-based testing answers yes — and shows how to do it in practice.
