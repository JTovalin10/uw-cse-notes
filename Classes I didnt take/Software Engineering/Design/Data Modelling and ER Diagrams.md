...
- [[Requirements Elicitation]] — the client-developer negotiation process that produces requirements
- [[Software Architecture Patterns]] — structural patterns for decomposing the system, the parallel design artifact produced alongside the data model
- [[Software Design Theory]] — the theoretical foundations underlying architectural and design decisions
- [[Entities, Relationships, and ER Diagrams]] — deeper treatment of ER diagrams and mapping to relational schemas
- [[Normalization]] — the normalization step referenced in the data modelling process
- [[Functional Dependencies (FDs)]] — the theoretical foundation for normalization
