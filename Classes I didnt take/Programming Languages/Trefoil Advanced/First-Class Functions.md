...
Trefoil supports **[[First-Class Function|First-Class Functions]]**, which means functions can be treated as values. This is achieved by adding `lambda` expressions and **[[Classes I didnt take/Programming Languages/Definitions/Part5/Closure|Closures]]** to the language.

## Lambdas and Closures

A `lambda` expression defines an anonymous function. When a `lambda` is evaluated, it creates a **[[Classes I didnt take/Programming Languages/Definitions/Part5/Closure|Closure]]**.
...
2. The **[[Classes I didnt take/Programming Languages/Definitions/Part5/Static Environment|Lexical Environment]]** that was active when the closure was created.
...
Closures implement **[[Classes I didnt take/Programming Languages/Definitions/Part4/Lexical Scope|Lexical Scope]]**, meaning variable resolution depends on where the function was defined, not where it is called. This makes code more predictable and modular, as functions don't unexpectedly interact with variables in the caller's scope.
...
- [[Structs and Pattern Matching|Structs and Pattern Matching]]
- [[Classes I didnt take/Programming Languages/Definitions/Part5/Closure|Closure]]
- [[First-Class Function|First-Class Function]]
- [[First Class Functions and Closures|First Class Functions and Closures (OCaml)]]
