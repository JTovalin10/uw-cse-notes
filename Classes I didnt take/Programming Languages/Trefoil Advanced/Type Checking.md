...
**[[Classes I didnt take/Programming Languages/Definitions/Part5/Type Checking|Type Checking]]** is a static analysis phase that occurs before a program is executed. It ensures that operations are performed on compatible types, preventing "stuck" states or undefined behavior during runtime.

## Static vs. Dynamic Environments

Type checking relies on a **[[Classes I didnt take/Programming Languages/Definitions/Part5/Static Environment|Static Environment]]** ($\Gamma$), which maps variables to their types. This is distinct from the **[[Classes I didnt take/Programming Languages/Definitions/Part5/Dynamic Environment|Dynamic Environment]]** ($E$), which maps variables to values.
...
- [[Classes I didnt take/Programming Languages/Definitions/Part5/Type Checking|Type Checking]]
- [[Classes I didnt take/Programming Languages/Definitions/Part5/Static Environment|Static Environment]]
- [[Classes I didnt take/Programming Languages/Definitions/Part5/Dynamic Environment|Dynamic Environment]]
- [[Classes I didnt take/Programming Languages/Type Systems/Type Inference|Type Inference (OCaml)]]
