...
Parsing is the process of converting a flat string of source code into a structured **[[Classes I didnt take/Programming Languages/Definitions/Part3/Abstract Syntax Tree (AST)|Abstract Syntax Tree (AST)]]**. This typically involves two phases: Lexing and Parsing.
...
A **[[Recursive Descent Parser|Recursive Descent Parser]]** uses a set of mutually recursive functions to process the token stream according to a context-free grammar.
...
The final output of the parser is an **[[Classes I didnt take/Programming Languages/Definitions/Part3/Abstract Syntax Tree (AST)|AST]]**. The AST represents the logical structure of the program, independent of surface syntax (like whether parentheses were used).
...
- [[Classes I didnt take/Programming Languages/Trefoil Advanced/Type Checking|Type Checking]]
