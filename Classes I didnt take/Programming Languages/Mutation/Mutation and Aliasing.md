...
While OCaml emphasizes immutability, it provides explicit support for mutable state via **[[Reference|References]]**. Understanding the distinction between identity and value is crucial when dealing with mutation.
...
**[[Classes I didnt take/Programming Languages/Definitions/Part2/Aliasing|Aliasing]]** occurs when multiple variables point to the same reference cell.
...
- [[Mutation and Objects|Mutation and Objects]]
