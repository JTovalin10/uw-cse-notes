...
1. **Type Checking (Static Semantics):**
   - The expression `e` is type-checked in the current **[[Classes I didnt take/Programming Languages/Definitions/Part0/Static Environment|Static Environment]]**.
...
2. **Evaluation (Dynamic Semantics):**
   - The expression `e` is evaluated in the current **[[Classes I didnt take/Programming Languages/Definitions/Part0/Dynamic Environment|Dynamic Environment]]** to produce a value `v`.
