...
- [[Finite State Machines]] — FSMs are sequential circuits where all combinational logic must meet these constraints
- [[Building Blocks]] — flip-flops are the state-holding elements subject to setup and hold requirements
- [[Combinational Logic]] — the logic between registers is what generates $t_{PD}$ and defines the critical path
- [[Verilog Fundamentals]] — synthesis tools use timing analysis to ensure generated circuits meet constraints
