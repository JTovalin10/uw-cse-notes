...
- [[Combinational Logic]] — all routing and computational elements are implemented as combinational logic circuits
- [[Finite State Machines]] — flip-flops used in FSM state registers; MUXes select next-state sources
- [[Timing Constraints]] — adder carry chain length determines the critical path and maximum clock frequency
- [[Memory and FPGAs]] — building blocks are instantiated as LUTs on an FPGA
