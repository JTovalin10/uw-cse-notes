...
- **Strictly Class Notes — No New Content (in the main body)**: The **main body** of each file reflects only what was taught in class. Do not add new topics, sub-concepts, or technical content that was not present in the source material into the main body. You may expand the "how" and "why" of existing content inline (e.g., explain the mechanism behind a stated fact), but do not introduce new concepts the user did not bring up, and do not branch into related topics. When content is terse, elaborate on what is already there.
  - **Deep Dive Section for Added Content**: If you want to add material that goes *beyond* what was covered in class — related concepts, deeper background, real-world extensions, cross-course tie-ins, or your own elaboration — place it in a dedicated **Deep Dive** section at the **bottom of the file** (after the narrative, before Industry Standard Terms / Related). This enforces a clean separation between *what was taught in class* (the main body) and *what you are adding on top of it* (the Deep Dive). Use a plain `## Deep Dive` heading (no emojis); never scatter added content through the main body. If you add nothing beyond class material, omit the section entirely.
...
11. **Preserve the user's original content and meaning** — reorganize and clean up, but do not add new topics or sub-concepts that were not in the source material into the main body. These are strictly class notes. If you want to add content beyond what was covered in class, put it in a dedicated **Deep Dive** section at the bottom of the file (see "Strictly Class Notes — No New Content").
