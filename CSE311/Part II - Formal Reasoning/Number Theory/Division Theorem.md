...
The remainder $r$ is what [[CSE311/Part II - Formal Reasoning/Number Theory/Modulo|modular arithmetic]] is built on, and when $r = 0$ we have exactly the [[CSE311/Part I - Mathematical Foundations/Sets and Relations/Divides|divides]] relationship $b \mid a$.
