...
1. $n \mid a$ and $n \mid b$ — $n$ is a common [[CSE311/Part I - Mathematical Foundations/Sets and Relations/Divides|divisor]].
...
We can repeatedly apply this fact to reduce the numbers until we get $\gcd(g, 0) = g$, which gives us the greatest common divisor. The fact holds because, by the [[CSE311/Part II - Formal Reasoning/Number Theory/Division Theorem|Division Theorem]], any common divisor of $a$ and $b$ is also a common divisor of $b$ and $a \bmod b$.
...
The [[CSE311/Part II - Formal Reasoning/Number Theory/Extended Euclid|Extended Euclidean Algorithm]] augments this process to also recover the Bézout coefficients $s, t$ with $\gcd(a,b) = sa + tb$.
