...
A **normal form** is a standardized way of writing a proposition so that any logical formula can be expressed in a fixed, predictable shape. Both normal forms below are read directly off a [[CSE311/Part I - Mathematical Foundations/Logic/Truth Tables|truth table]].
...
Every proposition can be converted to both CNF and DNF using [[CSE311/Part I - Mathematical Foundations/Logic/Truth Tables|truth tables]]. Because normal forms use only $\land$, $\lor$, and $\neg$, they map straight onto [[CSE311/Part I - Mathematical Foundations/Logic/Digital Circuits|digital circuits]] built from AND, OR, and NOT gates.
