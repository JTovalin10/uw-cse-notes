...
Satisfiability is decided by searching over variable assignments — in the worst case, every row of a [[CSE311/Part I - Mathematical Foundations/Logic/Truth Tables|truth table]] must be checked for a single True. An expression that is satisfiable on *every* row is a [[CSE311/Part I - Mathematical Foundations/Logic/Tautologies|tautology]]; one that is satisfiable on *no* row is a contradiction (unsatisfiable).
