...
- [[Anonymity in data|Anonymity in Data]] — anonymity in datasets and re-identification
- [[Computer Security/Side Channel Attacks/Side Channel Attacks|Side Channel Attacks]] — traffic analysis is a side-channel on networks
- [[Transport Layer Security (TLS)|TLS]] — encryption in transit, which E2EE builds on