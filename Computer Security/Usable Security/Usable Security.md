...
- [[Targets for Policy|Targets for Policy]] — the "people" layer is part of the whole-system security view
- [[Anonymity in data|Anonymity in Data]] — privacy behaviors and user expectations
- [[Hashing + Ciphertext Integrity|Hashing and Ciphertext Integrity]] — the hash functions underlying password hashing schemes
- [[Machine Learning Security|Machine Learning Security]] — disinformation attacks also target human judgment