...
- See also: [[Targets for Policy|Targets for Policy]]

## Related

- [[What is security]] — foundational security mindset
- [[How Systems Fail]] — why systems break down
- [[Computer Security/Security Fundamentals/Bug, Vulnerabilities, and exploits]] — bugs that become exploitable
- [[Targets for Policy|Targets for Policy]] — CIA triad and defining security properties
- 