...
- [[Groups|Groups]] — mathematical foundation (cyclic groups, generators)
- [[Transport Layer Security (TLS)|TLS]] — Diffie-Hellman is used in TLS for perfect forward secrecy