...
- [[Asymmetric Cryptography + key Exchange|Asymmetric Cryptography and Key Exchange]] — Diffie-Hellman and the discrete logarithm problem
- [[Public Key Encryption + Digital Signatures|Public Key Encryption and Digital Signatures]] — RSA and Schnorr signatures built on group theory