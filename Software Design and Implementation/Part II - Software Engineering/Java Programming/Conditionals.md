...
That is, the assertion at the top of the `then` branch includes the truth of the condition as a new **[[Facts|Fact]]**.
...
- [[Floyd Logic]]
- [[Hoare Triples]]
- [[Software Design and Implementation/Part II - Software Engineering/Java Programming/Loops]]
