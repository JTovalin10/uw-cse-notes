...
Both are mechanical rules for assignment: the only subtlety comes from [[Hardware & Software Interface/x86-64 Assembly/Loops|loops]], which require an invariant.
