...
Method specifications describe what a method requires of its inputs (**preconditions**) and what it promises about its outputs (**postconditions**). In Java, these are expressed in Javadoc using tags like `@param`, `@requires`, `@return`, `@throws`, [[@effects|@effects]], and [[@modifies|@modifies]].
...
- Add more detail to [[@effects|@effects]].
- Remove items from [[@modifies|@modifies]] (promising to modify less).
...
For how this is expressed in Javadoc comments, see [[Software Design and Implementation/Part I - Software Specifications/Software Specifications/Writing Methods Specs in Java]].

## Related

- [[Software Design and Implementation/Part I - Software Specifications/Software Specifications/Writing Methods Specs in Java]] — Javadoc form of these specs
...
- [[@effects|@effects]] — promises about mutation
- [[@modifies|@modifies]] — what may be changed
- [[Restricting Domain|Restricting Domain]] — preconditions as quantifier restrictions
- [[Side Conditions|Side Conditions]] — when conditions appear in function definitions
