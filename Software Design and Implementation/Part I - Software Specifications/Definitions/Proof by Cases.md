...
If we can prove it in those two cases, then it holds for all $x$ because those cases are **exhaustive** (see [[Exclusive and Exhaustive|Exclusive and Exhaustive]]). 
