...
- Specifications can also use [[Floyd Logic|Floyd Logic]] notation in `@effects` clauses (e.g., `obj = obj_0 ++ B`).
...
- [[Software Design and Implementation/Part I - Software Specifications/Software Specifications/Writing Methods Specs in Java|Writing Methods Specs in Java]]
- [[Mutation|Mutation]]
- [[Mutations of Arguments|Mutations of Arguments]]
- [[Mutations in ADT|Mutations in ADT]]
