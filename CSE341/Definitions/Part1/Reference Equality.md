**[[CSE341/Definitions/Part1/Reference Equality|Reference Equality]]**: A form of equality that checks if two names refer to the exact same object in memory (aliasing).
### Formal Definition
