**[[CSE341/Definitions/Part1/Variant|Variant]]**: A data type that represents a "one-of" choice between several different constructors, each potentially carrying different data.
### Formal Definition
