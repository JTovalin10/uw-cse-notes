...
The goal of **[[CSE341/Definitions/Part3/Tokenization|Tokenization]]** is to break the raw input string into indivisible units called **tokens**.
...
**[[CSE341/Definitions/Part3/Parsing|Parsing]]** converts the flat list of tokens into a tree structure.
...
A **[[CSE341/Definitions/Part3/Compiler|Compiler]]** for language `S` can be written in language `S` itself. This creates a circular dependency that is resolved as follows:
