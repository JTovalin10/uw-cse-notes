# Course: Lists and Tuples

OCaml builds complex programs from a sequence of bindings, each type-checked in a **[[CSE341/Definitions/Part1/Static Environment|Static Environment]]** and evaluated in a **[[CSE341/Definitions/Part1/Dynamic Environment|Dynamic Environment]]**. To handle data with multiple parts, OCaml uses compound data types, primarily **[[CSE341/Definitions/Part1/Tuple|Tuples]]** and **[[CSE341/Definitions/Part1/List|Lists]]**.

## Pairs and Tuples

A **[[CSE341/Definitions/Part1/Tuple|Tuple]]** is an "Each-Of" type (a **[[CSE341/Definitions/Part1/Product Type|Product Type]]**) that holds a fixed number of pieces of potentially different types.
...
For larger tuples, OCaml typically uses **[[CSE341/Definitions/Part1/Pattern Matching|Pattern Matching]]** (introduced later), as `fst` and `snd` are restricted to pairs.
...
A **[[CSE341/Definitions/Part1/List|List]]** holds any number of elements, but all must have the same type.
