...
*   **[[Multiple Input Multiple Output (MIMO)|MIMO]] (Multiple Input Multiple Output)**: Uses multiple antennas to increase throughput via spatial multiplexing (sending different data streams on different antennas).
