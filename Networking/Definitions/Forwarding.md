...
Distinct from [[Routing|Routing]] — forwarding is the **data-plane** action (fast, local), while routing is the **control-plane** process that builds the tables forwarding relies on (slow, network-wide).

![[Datagram Forwarding.png]]
