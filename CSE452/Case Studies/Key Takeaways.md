...
Case studies like **[[CSE452/Case Studies/Google File System (GFS)|Google File System (GFS)]]**, **[[CSE452/Case Studies/Big Table|Big Table]]**, and **[[CSE452/Case Studies/Dynamo|Dynamo]]** highlight several recurring strategies for building high-performance, durable, and available distributed systems at scale.
...
While **[[CSE452/Paxos/Paxos|Paxos]]** is necessary for correctness in the face of failures, it is often too slow for every individual operation due to the multiple network round-trips required for agreement.
...
There is a fundamental tension between **[[CSE452/Consistency/Consistency|Consistency]]** and **[[CSE452/Case Studies/Dynamo#Core Philosophy: Availability > Consistency|Availability]]**.
...
- [[CSE452/Case Studies/Dynamo|Dynamo]] — a case study in prioritizing availability over consistency
