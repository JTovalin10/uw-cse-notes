...
2. Which group (GID) owns which slice of data ([[CSE452/Sharding/Definitions/Shard|Shard]]).
...
## Related
- [[CSE452/Sharding/Definitions/ShardMaster|ShardMaster]] — the service that issues configurations
- [[CSE452/Sharding/Reconfiguration|Reconfiguration]] — how groups react to a new configuration
