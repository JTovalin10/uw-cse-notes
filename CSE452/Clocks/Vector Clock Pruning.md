...
- [[CSE452/Clocks/Vector Clock Algorithm|Vector Clock Algorithm]] — the full-size vector clock that pruning shrinks
- [[CSE452/Clocks/Logical Clocks|Logical Clocks]] — the happens-before relation that pruning can no longer perfectly track
- [[CSE452/Consistency/Weak Consistency Models|Weak Consistency Models]] — Last-Writer-Wins and conflict resolution under eventual consistency
