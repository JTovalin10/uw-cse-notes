...
This ensures that the function has a clear, unambiguous output for all possible inputs. See [[CSE331/Part I - Software Specifications/Definitions/Exclusive and Exhaustive|Exclusive and Exhaustive]].
