...
- **[[Spinlock]]**: A busy-wait primitive. The thread continuously checks the lock in a loop. Ideal for very short critical sections or when sleeping is not allowed (e.g., inside an interrupt handler).
