...
- on fork
	...
	- initialize page tables with same mappings as the parent's
		- they both point to the same physical memory
			- no copying of address space contents has occurred at this point — with the sole exception of the top page of the stack
