...
2. **Save State**: The OS takes a "snapshot" of the current process and saves the PC, SP, and other registers into its [[CSE451/Virtualization/Processes/Process/Process Control Block|Process Control Block (PCB)]].
...
## Related
- [[CSE451/Virtualization/Processes/Process|Process]]
