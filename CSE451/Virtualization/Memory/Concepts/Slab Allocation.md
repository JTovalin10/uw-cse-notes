...
## The Core Problem
1. **Internal Fragmentation**: Standard page-level allocators (like the [[CSE451/Virtualization/Memory/Concepts/Buddy Allocator|Buddy Allocator]]) allocate memory in large chunks (usually 4KB). If a kernel structure is only 256 bytes, using a full page is extremely wasteful.
...
3. If no empty slabs exist, it allocates a new page from the [[CSE451/Virtualization/Memory/Concepts/Buddy Allocator|Buddy Allocator]] and creates a new slab.
...
---
**See Also**: [[CSE451/Virtualization/Memory/Concepts/TLABs|TLABs]], [[CSE451/Virtualization/Memory/Concepts/Buddy Allocator|Buddy Allocator]]
