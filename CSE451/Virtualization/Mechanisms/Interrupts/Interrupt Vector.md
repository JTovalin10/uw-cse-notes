...
## Related
- [[CSE451/Virtualization/Mechanisms/Interrupts/Interrupts|Interrupts]] — what uses the interrupt vector for dispatch
- [[Trap Table]] — similar concept for traps/syscalls
- [[CSE451/Virtualization/Mechanisms/Interrupts/Interrupts#Safe Interrupts|Safe Interrupts]] — the interrupt vector is one of the three elements of safe interrupt handling
