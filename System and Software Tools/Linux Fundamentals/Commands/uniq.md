...
**uniq**: Filters out adjacent duplicate lines from a file or standard input. Because it only looks at *adjacent* lines, it is almost always used in combination with [[sort|sort]].
