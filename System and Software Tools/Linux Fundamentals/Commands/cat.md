...
**cat**: Short for "concatenate," used to read, output, and combine the content of one or more files to the terminal ([[Standard Streams#2. stdout (Standard Output) - File Descriptor 1|standard output]]).
