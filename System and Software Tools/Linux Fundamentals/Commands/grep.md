...
**grep**: Searches for patterns ([[Regex Basics|regular expressions]]) in files or standard input. It is one of the most powerful and widely used tools in the command line for filtering data.
