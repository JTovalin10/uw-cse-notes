...
A **Shell** is an interactive program that provides a text-based interface to the **[[System and Software Tools/Linux Fundamentals/Operating System|Operating System]]**. It takes commands from the user and gives them to the OS to execute.
