...
**Bash Scripting** is the process of writing a sequence of commands in a text file (a "script") to be executed by the [[Shell|Bash shell]], allowing for automation of complex tasks.
...
- [[Control Flow|Control Flow (If, For)]]
- [[Comparisons|Bash Comparisons]]
- [[Shell|The Shell]]
- [[seq|The seq Command]]
