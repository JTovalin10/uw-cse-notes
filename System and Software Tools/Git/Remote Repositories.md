# CSE391: Remote Repositories

A **Remote Repository** is a version of your project that is hosted on the Internet or some other network. This allows you to back up your work and collaborate with others.
...
| `origin` | Default remote name (convention, not enforced) |
| Remote Tracking Branch | Remote-tracking reference (e.g., `origin/main`) |
| git clone | Clone — download a repository and its full history |
| git push | Push — upload local commits to remote |
| git fetch | Fetch — download remote changes without merging |
| git pull | Pull — fetch + merge into current branch |
