...
**find** and **[[cut|cut]]** are powerful tools for searching the file system and extracting specific portions of text data.
...
The **[[cut|cut]]** command extracts specific columns or fields from each line of text data.
...
- [[Xargs|Xargs]]
- [[grep|grep — pattern-based file search]]
