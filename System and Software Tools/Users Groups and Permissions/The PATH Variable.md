...
The **$PATH** variable is one of the most critical environment variables in Unix/Linux. It tells the **[[Shell|Shell]]** which directories to search for executable programs when you type a command.
