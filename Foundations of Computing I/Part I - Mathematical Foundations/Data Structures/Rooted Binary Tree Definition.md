...
A **rooted binary tree** is an [[Foundations of Computing I/Part I - Mathematical Foundations/Data Structures/Inductive Data Types|inductive data type]] defined recursively, following the basis-plus-recursive-step pattern of a [[Recursive Definition of Sets|recursive set definition]].
...
- [[Rooted Binary Trees Functions|Rooted Binary Trees Functions]]
