...
In **digital circuits**, the logical truth values of [[Boolean Algebra|Boolean algebra]] map directly onto binary electrical signals:
...
Because any proposition can be written in [[Normal Form|CNF or DNF]], any logical function can be built physically from just AND, OR, and NOT gates.
