...
**Set operations** can be translated into propositional logic, allowing us to reason about them with the same tools as [[Logical Equivalence(s)|logical equivalences]]. This translation is formalized in [[Sets and Logic|Sets and Logic]].
...
These laws are the set-theoretic mirror of the propositional [[DeMorgans Laws|De Morgan's]] and distributive laws — replace $\cup$ with $\lor$ and $\cap$ with $\land$ and they become identical.
