...
[[What is a Set|Sets]] and [[What is a Predicate|predicates]] are two sides of the same coin — every set defines a predicate, and every predicate defines a set.
...
This correspondence means that reasoning about set membership is equivalent to reasoning about truth values of predicates, so logical tools (conjunction, disjunction, negation, quantifiers) apply directly to [[Operations on Sets|set operations]].
