...
These **inference rules** extend [[Formal Proofs|formal proofs]] to formulas containing [[What are Quantifiers|quantifiers]]. As with the propositional rules, each rule either *introduces* a quantifier (building a quantified statement) or *eliminates* one (extracting a usable instance).
