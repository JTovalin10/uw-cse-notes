...
Further, by the definition of [[Divides|Divides]], this means:
...
Solving congruences of the form $ay \equiv_m b$ for $y$ requires a [[Extended Euclid|multiplicative inverse]], which is found with the Extended Euclidean Algorithm.
