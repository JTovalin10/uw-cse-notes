...
An **n-bit integer representation** fixes how a finite block of $n$ bits encodes a whole number. Because only $2^n$ bit patterns exist, every scheme below is fundamentally an instance of [[Modulo|arithmetic modulo]] $2^n$.
