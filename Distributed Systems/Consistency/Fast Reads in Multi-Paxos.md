...
In [[Multi-Paxos|Multi-Paxos]], the leader is a bottleneck for all operations. Fast reads allow replicas to serve reads locally, providing:
...
- [[Multi-Paxos|Multi-Paxos]] — the consensus protocol whose leader bottleneck fast reads relieve
- [[Linearizability|Linearizability]] — the strong guarantee that fast reads relax
- [[Weak Consistency Models|Weak Consistency Models]] — eventual consistency, the model behind eventually consistent reads
