...
- [[Lamport Clock Algorithm|Lamport Clock Algorithm]] — the simpler single-counter implementation
- [[Vector Clock Pruning|Vector Clock Pruning]] — managing vector clock size at scale
- [[Idempotence|Idempotence]] — causality helps ensure operations are not repeated incorrectly
