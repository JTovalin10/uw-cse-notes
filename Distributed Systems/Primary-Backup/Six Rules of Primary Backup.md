...
- See [[State Machine Replication (State Transfer)|State Transfer]] for the full mechanics
...
- [[Primary Backup|Primary-Backup Replication]] — full overview of the primary-backup model, view server, and state transfer
- [[View Server|View Server]] — the authority that enforces these rules
- [[State Machine Replication (State Transfer)|State Transfer]] — mechanics of transferring state to a newly promoted backup
- [[Failover Protocol|Failover Protocol]] — how failure detection triggers view changes
- [[Idempotence|Idempotence]] — why operations must be safe to re-execute during recovery
