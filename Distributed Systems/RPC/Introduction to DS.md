...
- **Performance**: place data and computation near users; use [[Caching|caching]] to reduce latency
...
## Related
- [[Fault Model|Fault Model]] — catalog of failures a DS must tolerate
- [[Remote Procedure Call (RPC)|Remote Procedure Call (RPC)]] — how machines communicate across a network
- [[Primary Backup|Primary-Backup Replication]] — one approach to fault-tolerant state replication
- [[Deterministic State Machine|Deterministic State Machine]] — formal model underlying replication
- [[Logical Clocks|Logical Clocks]] — reasoning about concurrency and event ordering
