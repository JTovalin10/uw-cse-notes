...
## Related
- [[Single Paxos|Single Decree Paxos]] — the algorithm these scenarios trace through
- [[Majority Overlap|Majority Overlap]] — the property that makes these scenarios safe
- [[Paxos Invariants|Paxos Invariants and Design]] — the formal rules behind "chosen"
