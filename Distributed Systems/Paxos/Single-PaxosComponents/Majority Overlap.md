...
## Related
- [[Single Paxos|Single Decree Paxos]] — the algorithm that relies on majority overlap
- [[Paxos Invariants#1. The Quorum Intersection Property|Quorum Intersection Property]] — the formal invariant
- [[Safety and Scenarios|Safety and Scenarios]] — worked examples of overlap preserving agreement
