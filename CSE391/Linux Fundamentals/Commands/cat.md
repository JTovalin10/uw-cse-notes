...
**cat**: Short for "concatenate," used to read, output, and combine the content of one or more files to the terminal ([[CSE391/Streams Redirection and Pipes/Standard Streams#2. stdout (Standard Output) - File Descriptor 1|standard output]]).
...
| :--- | :--- |
| cat | GNU coreutils `cat` — concatenate and print files |
