...
Permanent deletion — there is no recycle bin.
```bash
rm old_notes.txt
```
...
## Related
- [[CSE391/Linux Fundamentals/Commands/cp|cp]]
- [[CSE391/Linux Fundamentals/Commands/mv|mv]]
- [[CSE391/Intermediate Command Line/Find and Cut|find — used in combination with rm]]
