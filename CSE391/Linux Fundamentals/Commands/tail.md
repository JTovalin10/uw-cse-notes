...
## Related
- [[CSE391/Linux Fundamentals/Commands/head|head]]
...
| :--- | :--- |
| tail | GNU coreutils `tail` — output the last part of files |
| tail -f | Log tailing / `tail --follow` — real-time log monitoring |
