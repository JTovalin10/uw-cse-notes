...
Common tools that support [[CSE391/Regular Expressions/Regex Basics|regular expressions]] in the Unix environment.

## grep

The most common tool for searching text using regular expressions. See the full reference at **[[CSE391/Linux Fundamentals/Commands/grep|grep]]**.
...
A **stream editor** for filtering and transforming text using regex substitutions. See the full reference at **[[CSE391/Sed/Sed Commands|sed]]**.
...
- [[CSE391/Sed/Sed Commands|Detailed Sed Reference]]
