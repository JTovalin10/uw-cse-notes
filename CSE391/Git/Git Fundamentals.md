...
- [[CSE391/Git/Git Workflow|Git Workflow]]
...
| Commit | Git commit — a snapshot of staged changes |
| Branch | Git branch — a moveable pointer to a commit |
| HEAD | Git HEAD — pointer to the current commit/branch |
| GitLab | GitLab — self-hosted or cloud Git remote hosting |
