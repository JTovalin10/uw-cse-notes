...
**Bash Scripting** is the process of writing a sequence of commands in a text file (a "script") to be executed by the [[CSE391/Linux Fundamentals/Shell|Bash shell]], allowing for automation of complex tasks.
...
Bash is **loosely typed**, meaning variables do not have strict data types like `int` or `boolean`.
...
- [[CSE391/Bash Scripting/Control Flow|Control Flow (If, For)]]
- [[CSE391/Bash Scripting/Comparisons|Bash Comparisons]]
- [[CSE391/Linux Fundamentals/Shell|The Shell]]
- [[CSE391/Bash Scripting/Seq|The seq Command]]

## Industry Standard Terms
| Course Term | Industry-Standard Equivalent |
| :--- | :--- |
| Shebang (`#!`) | Shebang / hashbang — interpreter directive |
| Bash scripting | Shell scripting / Bash scripting |
| Variable Expansion | Parameter expansion / shell expansion |
| Command Substitution | Command substitution — `$()` syntax |
