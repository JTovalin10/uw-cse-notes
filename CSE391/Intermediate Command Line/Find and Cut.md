...
**find** and **[[CSE391/Linux Fundamentals/Commands/cut|cut]]** are powerful tools for searching the file system and extracting specific portions of text data.
...
The **[[CSE391/Linux Fundamentals/Commands/cut|cut]]** command extracts specific columns or fields from each line of text data.
...
- [[CSE391/Intermediate Command Line/Xargs|Xargs]]
- [[CSE391/Linux Fundamentals/Commands/grep|grep — pattern-based file search]]

## Industry Standard Terms
| Course Term | Industry-Standard Equivalent |
| :--- | :--- |
| find | GNU findutils `find` — file hierarchy search |
| cut | GNU coreutils `cut` — extract fields/columns from text |
