...
CSE 403 covers four program analysis approaches: testing (covered earlier in the course), delta debugging (covered earlier in [[CSE403/Program Analysis/Static and Dynamic Analysis]]), abstract interpretation (primer, see [[CSE403/Program Analysis/Static Analysis]]), and theorem proving / solver-aided reasoning via [[CSE403/Program Analysis/Z3 and SMT Solvers|Z3]].
...
Loop invariants connect directly to material from [[CSE331/Part II - Software Engineering/Java Programming/Loop invariants with pictures|CSE 331 Loop Invariants]], where this framework is developed in depth.
...
- [[CSE403/Testing/Delta Debugging]]
- [[CSE331/Part II - Software Engineering/Java Programming/Loop invariants with pictures]]
- [[CSE331/Part II - Software Engineering/Java Programming/Loop to Tail Recursion]]
