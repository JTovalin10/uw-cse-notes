...
A **test double** is an object that replaces a real dependency in a unit test. The term is a generalization; there are several specific subtypes. See [[CSE403/Testing/Mock-Based Testing]] for how test doubles are implemented using Mockito in practice.
...
CI pipelines often integrate **code coverage reporting** — running the test suite with coverage instrumentation and reporting the percentage of statements, branches, or lines exercised. See [[CSE403/Testing/Coverage-Based Testing]] for a full treatment of coverage criteria, the CFG, and MC/DC. Coverage reports can:
...
- [[CSE403/Software Process/SDLCModelsComponents/Agile and Scrum Details]]
