...
These techniques divide naturally into black-box (specification-based) and white-box (structural) approaches, introduced in [[CSE403/Testing/Testing Fundamentals]].
