...
Master navigation hub for CSE 351 notes. For a course overview and goals, see the [[Hardware & Software Interface/README|README]].
...
- [[Hardware & Software Interface/Memory Fundamentals/Pointers|Pointers (including Pointer Arithmetic)]] — pointer definition and dereferencing
...
- [[Hardware & Software Interface/x86-64 Assembly/Conditionals|Conditionals]] — if-else assembly patterns
- [[Hardware & Software Interface/x86-64 Assembly/Loops|Loops]] — loop implementation in assembly
...
- [[Hardware & Software Interface/Procedures and Stack/Memory Layout|Memory Layout]] — stack, heap, data, code segment arrangement
...
## Data Structures
- [[Hardware & Software Interface/Data Structures/Arrays|Arrays]] — array storage and indexing in memory
...
- [[Hardware & Software Interface/Cache/Side Channel Attacks|Side Channel Attacks (Spectre, Flush+Reload)]]
...
- [[Hardware & Software Interface/Memory Management/Virtual Memory|Virtual Memory]] — virtual memory abstraction
- [[Hardware & Software Interface/Memory Management/Paging|Paging]] — virtual memory paging mechanism
...
- [[Hardware & Software Interface/System Programming/System Calls|System Calls]] — kernel service requests
