...
The scale `8` corresponds to the size of a `long` or pointer, matching [[Hardware & Software Interface/Data Structures/Arrays|array]] element sizes automatically.
...
- [[Hardware & Software Interface/Memory Fundamentals/Pointers|Pointer Arithmetic]]
