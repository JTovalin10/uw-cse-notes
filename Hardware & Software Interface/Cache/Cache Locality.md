...
**Spatial locality** exists when locations near a recently referenced location are likely to be referenced soon. This occurs with sequential instruction execution and with data structures like [[Hardware & Software Interface/Data Structures/Arrays|arrays]], where adjacent elements are accessed one after another.
...
- [[Hardware & Software Interface/Data Structures/Arrays|Arrays (spatial locality example)]]
