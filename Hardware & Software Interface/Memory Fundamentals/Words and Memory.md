...
- The **address space** is the set of all possible addresses the CPU can generate; for a process this is the virtual address space managed by [[Hardware & Software Interface/Memory Management/Virtual Memory|Virtual Memory]].
...
- [[Hardware & Software Interface/Memory Fundamentals/Pointers|Pointers (including Pointer Arithmetic)]]
