...
## Hardware and Tools
- **[[CSE369/Memory and FPGAs|FPGA]]**: Field-Programmable Gate Array — Intel Altera Cyclone V board used for all lab implementations.
- **[[CSE369/Verilog Fundamentals|Verilog]]**: Hardware Description Language (HDL) used to describe and synthesize circuits onto the FPGA.

## Course Index
See [[CSE369/CSE369 Index]] for all topics and notes.
