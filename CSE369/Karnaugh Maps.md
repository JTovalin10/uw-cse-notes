...
- [[CSE369/Combinational Logic]] — K-maps minimize the Boolean expressions that describe combinational circuits
- [[CSE369/Finite State Machines]] — K-maps are used in FSM design to minimize next-state and output logic
- [[CSE369/Building Blocks]] — minimized logic is what gets realized as physical gate networks
