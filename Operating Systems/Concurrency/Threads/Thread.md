...
- Each thread has its own:
	- [[CPU State#Program Counter (PC)|Program Counter]] - tracks which instruction to execute next
	- [[CPU State#Registers|Registers]] - holds thread-specific data
	- [[CPU State#Stack Pointer (SP)|Stack Pointer]] / Stack - for function calls and local variables
