- value is 0 or 1
- Guarantees [[Operating Systems/Concurrency/Synchronization/Mechanics/Mutual Exclusion]] access to resource
- only one [[Thread|Thread]]/[[Process|Process]] allowed entry at a time
	- uses a queue
