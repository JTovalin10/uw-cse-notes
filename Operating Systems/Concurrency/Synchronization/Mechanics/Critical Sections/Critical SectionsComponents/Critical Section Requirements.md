...
- see [[Operating Systems/Concurrency/Synchronization/Mechanics/Mutual Exclusion]]

## Progress
- if [[Thread|Thread]] T is outside the critical section, then T cannot prevent thread S from entering the critical section
