...
4. retrieval: if the program later tries to access that data, a [[Page Fault]] [[Operating Systems/Virtualization/Mechanisms/Exceptions/Exception|Exception]] occurs. The OS then "swaps in" the page from the disk back into ram