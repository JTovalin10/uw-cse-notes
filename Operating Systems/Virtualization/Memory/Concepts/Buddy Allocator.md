...
- **Internal Fragmentation**: Can be significant. If a process needs 65KB, the allocator must provide 128KB (the next power of two), wasting nearly 50% of the allocated block. This is the primary reason the [[Slab Allocation|Slab Allocation]] mechanism exists—to manage the space *within* the pages provided by the Buddy Allocator.

---
**See Also**: [[Slab Allocation|Slab Allocation]], [[Variable Partitions|Variable Partitions]]
