...
The [[Operating Systems/Virtualization/Architecture/Operating System]] sits between application programs and the hardware:
- It mediates access and abstracts away ugliness
- Programs request services via [[Traps|Traps]] or [[Exceptions]]
- Devices request attention via [[Interrupts|Interrupts]]
