...
**Atomic transfer of control** is the hardware mechanism that transitions from user mode to kernel mode in a single, uninterruptible step. It is one of the three requirements for [[Interrupts#Safe Interrupts|Safe Interrupts]].
...
## Related
- [[Traps|Traps]] — traps use atomic transfer of control to enter the kernel
- [[Interrupts|Interrupts]] — interrupts also use atomic transfer
