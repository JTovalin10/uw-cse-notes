...
**Transmission Control Protocol (TCP)** is a connection-oriented, full-duplex, reliable transport protocol. It abstracts the underlying unreliable, packet-switched network provided by **[[CSE461/Network Layer/Network Layer - Internetworking and IP|Internet Protocol (IP)]]** into a logical, bit-perfect pipe between two application processes.
...
## Related
- [[CSE461/Transport/Transport Layer - TCP Congestion Control|TCP Congestion Control (AIMD, Slow Start)]]
- [[CSE461/Network Layer/Network Layer - Internetworking and IP|Network Layer and IP]]
...
- [[CSE333/Networking/TCP Sockets|CSE333: TCP Sockets in C]]
