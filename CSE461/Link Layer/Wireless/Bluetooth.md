...
- Because the communicating devices typically belong to one individual or group, Bluetooth is sometimes categorized as a **Personal Area Network (PAN)**, a step smaller than a [[Local Area Network (LAN)|LAN]].
