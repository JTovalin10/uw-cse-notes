[[Network Switch (Switching)|Switches]] collectively find a spanning tree for the topology
...
3. turn off ports for forwarding as they aren't on the spanning tree
...
Problems:
Due to overhead (not the most optimal paths) and bottlenecks (root), this doesn't scale and is only good for small-scale links.
