...
- After a collision the adaptor picks a random *k* in `[0, 2^n − 1]` and waits *k × 51.2 µs*, where *n* is the number of collisions so far for the current packet (resets with every new packet).
