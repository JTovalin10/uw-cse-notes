...
- The scheduler can allocate [[OFDMA]] resource blocks to users **and** dynamically adjust the **size** of those blocks
...
2. **Ensure every UE** receives its required level of service

This algorithm is **not specified by 3GPP** — it is the proprietary intellectual property of the BBU vendors.
