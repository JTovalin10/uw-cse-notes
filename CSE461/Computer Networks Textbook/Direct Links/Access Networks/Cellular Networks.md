...
The main innovation of [[Long-Term Evolution (LTE)|LTE]]'s air interface is how it allocates the available radio spectrum to UEs.
...
See [[Orthogonal Frequency-Division Multiple Access (OFDMA)|OFDMA]] for the details of LTE's media access mechanism, and [[5G Spectrum]] for how 5G extends this.
