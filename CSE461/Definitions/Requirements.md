...
Connecting every node directly does not scale. Two solutions:
...
Networks use [[Multiplexing]] to share resources among multiple users, similar to timesharing a computer. Three main multiplexing approaches:
- **[[Synchronous Time-Division Multiplexing]]** — divides time into equal quanta; each flow gets a round-robin turn
- **[[Frequency Division Multiplexing (FDM)]]** — each flow transmits at a different frequency
- **[[Statistical Multiplexing]]** — like STDM but data is transmitted on demand rather than in predetermined slots, so idle flows do not waste capacity
...
## Related
- [[Link]] — the physical medium connecting nodes
- [[Switch]] — connects links to form larger networks
- [[Multiplexing]] — resource sharing overview
- [[Software]] — the Socket API for applications to use the network
