...
- Used in [[Hop-by-Hop Flow Control]] between adjacent nodes in [[Virtual Circuit]] networks
- Window size determines how many unacknowledged packets can be in flight

For a detailed breakdown of sender/receiver state and invariants, see [[Sliding Window]].
