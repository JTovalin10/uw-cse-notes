...
Datagram networks are [[Connectionless]]—no connection setup is required before sending data. The Internet's [[Internet Protocol (IP)|IP]] layer uses datagram delivery.
