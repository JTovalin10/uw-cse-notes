...
The **[[CSE461/Definitions/Internet Protocol (IP)|Internet Protocol (IP)]]** acts as the "narrow waist" of the hourglass: it abstracts away the complexity of various hardware links below it and provides a unified interface for the myriad of applications above it.
...
Used by **[[CSE461/Definitions/IPv4|IPv4]]** and **[[CSE461/Definitions/IPv6|IPv6]]**.
...
Used by **ATM**, **Frame Relay**, and modern **[[CSE461/Network Layer/Network Layer - MPLS|MPLS]]**.
...
## Related
- [[CSE461/Link Layer/Link Layer Overview|Link Layer Overview]]
- [[CSE461/Transport/Transport Layer - Transmission Control Protocol (TCP)|Transport Layer: TCP]]
- [[CSE461/Network Layer/Fragmentation and PMTUD|IP Fragmentation and MTU]]
- [[CSE452/Primary-Backup/Why Not Just Use TCP|CSE452: Why Not Just Use TCP? (Reliability over Unreliable IP)]]
