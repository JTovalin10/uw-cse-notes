...
3. **No match** → consult the [[Forwarding Table]] to find the [[Next Hop Router]] and [[Forwarding|forward]] there

## Longest Prefix Match

Forwarding table entries may have overlapping prefixes. For each packet, the router applies [[Longest matching prefix]] — it selects the most specific entry (longest prefix) containing the destination address and forwards to the next hop for that entry.

See also: [[IP Address]], [[Subnetting]], [[Classless Interdomain Routing (CIDR)]], [[Longest matching prefix]], [[Next Hop Router]]
