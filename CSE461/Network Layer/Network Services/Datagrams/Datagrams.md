...
![[Datagrams.png]]
Every packet carries the complete destination address.  Each Switches use a [[Forwarding Table]]  keyed by address to determine the next hop. While forwarding itself is straightforward, the hard part is [[CSE461/Network/Routing]] — building and maintaining those tables as the network scales.
